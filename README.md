...
This script marks the very first use a VMS System Service (runtime library routines) used in a VMS Ruby program, specifically the `RTL::set_symbol()` routine, as SWIGged into VMS Ruby by Cameron Brett, Director of Applications & Open Source Services, VMS Software Inc (VSI).  Thanks, Brett!
...
This script marks the second use a VMS System Service (runtime library routines) used in a VMS Ruby program, specifically the `RTL::set_symbol()` routine, as SWIGged into VMS Ruby by Cameron Brett, Director of Applications & Open Source Services, VMS Software Inc (VSI).
